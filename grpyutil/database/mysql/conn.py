...
def get_table_conn(sql_path):
    ...
    return TableConn(conn, sql_config["table"])
...
class TableConn(object):
    ...
    def execute(self, query, args=None):
        ...
        return self.db_conn_object.execute(query, args=None)

    def read_data(self, read_linenum=0, begin_index=0, begin_id_index=0):
